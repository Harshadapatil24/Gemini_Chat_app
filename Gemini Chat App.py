...
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyCYvSipSyra2QMAN9-uC_jK0lfGyNTDry8")  # Replace with your actual API key
...
if prompt := st.chat_input("Ask me anything that you want ..."):
